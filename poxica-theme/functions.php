...
/**
 * Poxica Theme functions.
 *
 * @package poxica-theme
 */

/**
 * Assign the Poxica Theme version to a var
 */
$theme               = wp_get_theme( 'poxica-theme' );
$poxica_theme_version = $theme['Version'];
define( 'POXICA_THEME_VERSION', $poxica_theme_version );

/**
 * Global Paths
 */
define( 'POXICA_THEME_CORE', get_template_directory() . '/inc/core' );

if ( ! function_exists( 'poxica_theme_typography2_enabled' ) ) {
	/**
	 * Determines whether or not to load typography 2.0
	 *
	 * @since 2.0
	 */
	function poxica_theme_typography2_enabled() {
		$default = false;
		return (bool) apply_filters( 'poxica_theme_typography2_enabled', $default );
	}
}
